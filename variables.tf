...
variable "max_instances" {
  type        = number
  description = "Maximum number of Access Tier instances"
  default     = 10
}

variable "desired_instances" {
  type        = number
  description = "Desired number of Access Tier instances (if not specified, uses min_instances)"
  default     = null
}

variable "disable_scale_in" {
  type        = bool
  description = "Disable scale-in for the autoscaling policy"
  default     = false
}

variable "enable_availability_zone_distribution" {
  type        = bool
  description = "Enable availability zone distribution strategy"
  default     = false
}

variable "capacity_distribution_strategy" {
  type        = string
  description = "Capacity distribution strategy for availability zones"
